...
{
    public class ButtonsDemoVm : BaseViewModel
    {
        public ButtonsDemoVm()
        {
        ...
        public override Page View { get; set; } = new Views.ButtonsDemoView();
        #endregion
        ...
        private void ActionGiveOskar(object param)
        {
            if (param is Actor actor)
            {
                actor.HasOskar = !actor.HasOskar;
            }
        }
